...
export const BOSSES: Boss[] = [
  {
    ...
    coverImage: require("../assets/bosses/isleOne/root-pack/root-pack2.png"),
    images: [
      require("../assets/bosses/isleOne/root-pack/root-pack.gif"),
      require("../assets/bosses/isleOne/root-pack/root-pack.png"),
      require("../assets/bosses/isleOne/root-pack/root-pack2.png"),
    ],
    difficulty: 0.5,
    isle: 1,
  },
  {
    ...
    description:
      "Goopy Le Grande is one of the three bosses initially available.",
    appearance:
    ...
    coverImage: require("../assets/bosses/isleOne/goopy-le-grande/goopy-le-grande.png"),
    images: [
      require("../assets/bosses/isleOne/goopy-le-grande/goopy-le-grande.gif"),
      require("../assets/bosses/isleOne/goopy-le-grande/goopy-le-grande2.gif"),
      require("../assets/bosses/isleOne/goopy-le-grande/goopy-le-grande3.gif"),
      require("../assets/bosses/isleOne/goopy-le-grande/goopy-le-grande4.png"),
    ],
    difficulty: 0.5,
    isle: 1,
  },
  {
    ...
    name: "Hilda Berg",
    description:
      "A zeppelin boss that transforms into various forms, found in the first isle.",
    appearance:
      "Hilda Berg bares a rather stylized design to her physical appearance in contrast to a few of the other females in the game. She has a tall, slender figure appearing as a human-zeppelin hybrid (which is seen for a split second before she eats the cloud which causes her to transform). She has pinkish, fair-colored skin and short black hair in a finger-wave haircut with a prominent hair-line in the center. Her facial structure consists of a long, pointed nose, thin black eyebrows, salmon eyelids, and three thin black eyelashes on each eye.",
    personality:
      "Hilda Berg is said to have a mischievous and playful personality. She seems fairly rude when it comes to pestering her enemies, as indicated by how she teases the brothers on how far they will get to actually beat her on the constellation screen and will even call them a wimp as seen in her Blimp death message.",
    coverImage: require("../assets/bosses/isleOne/hilda-berg/hilda-berg.png"),
    images: [
      require("../assets/bosses/isleOne/hilda-berg/hilda-berg.gif"),
      require("../assets/bosses/isleOne/hilda-berg/hilda-berg2.gif"),
      require("../assets/bosses/isleOne/hilda-berg/hilda-berg3.png"),
      require("../assets/bosses/isleOne/hilda-berg/hilda-berg4.gif"),
    ],
    difficulty: 1,
    isle: 1,
  },
  {
    ...
    description:
      "A flower boss with a thorny personality, found in the first isle.",
    appearance:
      "At first, Cagney seems like an innocent-looking flower with a stamen as a face, orange cheeks, a small, pointed nose, six orange petals, each with stripes of a darker shade of orange on the tips, large leaves that act like hands, and a dark green stem with four light green leaves on the bottom. However, shortly after, Cagney's stem grows small yellow thorns, his petals get a pointed tip in the middle of each of them, his orange cheeks completely disappear, his nose gets longer, his eyes become larger, and his leaves turn into long arms with actual hands.",
    personality:
      "Cagney is sneaky and cunning. He seems to delight in catching his enemies off guard with his appearance, posing as a harmless and adorable flower before roaring loudly. He also seems to be slightly crazed in his final phase, with his maniacal grin and shrieking laughter.",
    coverImage: require("../assets/bosses/isleOne/cagney-carnation/cagney-carnation.png"),
    images: [
      require("../assets/bosses/isleOne/cagney-carnation/cagney-carnation.gif"),
      require("../assets/bosses/isleOne/cagney-carnation/cagney-carnation2.gif"),
      require("../assets/bosses/isleOne/cagney-carnation/cagney-carnation3.png"),
      require("../assets/bosses/isleOne/cagney-carnation/cagney-carnation4.png"),
    ],
    difficulty: 1.5,
    isle: 1,
  },
  {
    ...
    personality:
      "Ribby and Croaks are well-meaning hooligans with hearts of gold and a lot of moxie—sometimes a little too much moxie. Since their childhood, they were tough fighters born in the worst environments, as implied in their quotes. The fact that Ribby bawls and Croaks bangs his fist on the ground in anger when defeated in Simple mode implies that they may be somewhat dramatic and perhaps sore losers (although Croaks is such in a more aggravated way while Ribby is merely a wimp). Also, Ribby seems to sacrifice himself in order to help Croaks be stronger, showing that the brothers will do anything to protect each other.",
    coverImage: require("../assets/bosses/isleOne/ribby-and-croaks/ribby-and-croaks.png"),
    images: [
      require("../assets/bosses/isleOne/ribby-and-croaks/ribby-and-croaks.gif"),
      require("../assets/bosses/isleOne/ribby-and-croaks/ribby-and-croaks2.gif"),
      require("../assets/bosses/isleOne/ribby-and-croaks/ribby-and-croaks3.gif"),
      require("../assets/bosses/isleOne/ribby-and-croaks/ribby-and-croaks4.png"),
    ],
    difficulty: 2,
    isle: 1,
  },
  {
    ...
    coverImage: require("../assets/bosses/isleTwo/baroness-von-bon-bon/baroness-von-bon-bon.png"),
    images: [
      require("../assets/bosses/isleTwo/baroness-von-bon-bon/baroness-von-bon-bon.gif"),
      require("../assets/bosses/isleTwo/baroness-von-bon-bon/baroness-von-bon-bon2.png"),
      require("../assets/bosses/isleTwo/baroness-von-bon-bon/baroness-von-bon-bon3.png"),
      require("../assets/bosses/isleTwo/baroness-von-bon-bon/baroness-von-bon-bon4.png"),
      require("../assets/bosses/isleTwo/baroness-von-bon-bon/baroness-von-bon-bon5.png"),
    ],
    difficulty: 2.5,
    isle: 2,
  },
  {
    ...
    description:
      "Beppi The Clown is one of the three bosses initially available after entering this isle.",
    appearance:
    ...
    coverImage: require("../assets/bosses/isleTwo/beppi-the-clown/beppi-the-clown.png"),
    images: [
      require("../assets/bosses/isleTwo/beppi-the-clown/beppi-the-clown.gif"),
      require("../assets/bosses/isleTwo/beppi-the-clown/beppi-the-clown2.png"),
      require("../assets/bosses/isleTwo/beppi-the-clown/beppi-the-clown3.png"),
      require("../assets/bosses/isleTwo/beppi-the-clown/beppi-the-clown4.png"),
    ],
    difficulty: 2.5,
    isle: 2,
  },
  {
    ...
    description:
      "A genie boss with a variety of magical attacks, found in the second isle.",
    appearance:
    ...
    personality:
      "Djimmi The Great is said to have vivacious personality. In the game, he seems to treat battling in a playful way like a manipulative trickster, as he has a near-constant grin on his face throughout the fight.",
    coverImage: require("../assets/bosses/isleTwo/djimmi-the-great/djimmi-the-great.png"),
    images: [
      require("../assets/bosses/isleTwo/djimmi-the-great/djimmi-the-great.png"),
      require("../assets/bosses/isleTwo/djimmi-the-great/djimmi-the-great2.png"),
      require("../assets/bosses/isleTwo/djimmi-the-great/djimmi-the-great3.png"),
    ],
    difficulty: 3,
    isle: 2,
  },
  {
    ...
    name: "Wally Warbles",
    description:
      "An angry bird boss that attacks in various ways, found in the second isle.",
    appearance:
    ...
    coverImage: require("../assets/bosses/isleTwo/wally-warbles/wally-warbles.png"),
    images: [
      require("../assets/bosses/isleTwo/wally-warbles/wally-warbles.png"),
      require("../assets/bosses/isleTwo/wally-warbles/wally-warbles2.png"),
      require("../assets/bosses/isleTwo/wally-warbles/wally-warbles3.png"),
      require("../assets/bosses/isleTwo/wally-warbles/wally-warbles4.png"),
    ],
    difficulty: 3,
    isle: 2,
  },
  {
    ...
    coverImage: require("../assets/bosses/isleTwo/grim-matchstick/grim-matchstick.png"),
    images: [
      require("../assets/bosses/isleTwo/grim-matchstick/grim-matchstick.gif"),
      require("../assets/bosses/isleTwo/grim-matchstick/grim-matchstick2.png"),
      require("../assets/bosses/isleTwo/grim-matchstick/grim-matchstick3.png"),
      require("../assets/bosses/isleTwo/grim-matchstick/grim-matchstick4.png"),
    ],
    difficulty: 4,
    isle: 2,
  },
  {
    ...
    coverImage: require("../assets/bosses/isleThree/rumor-honeybottoms/rumor-honeybottoms.png"),
    images: [
      require("../assets/bosses/isleThree/rumor-honeybottoms/rumor-honeybottoms.gif"),
      require("../assets/bosses/isleThree/rumor-honeybottoms/rumor-honeybottoms2.png"),
      require("../assets/bosses/isleThree/rumor-honeybottoms/rumor-honeybottoms3.png"),
    ],
    difficulty: 3,
    isle: 3,
  },
  {
    ...
    description:
      "A theatrical boss with dramatic attacks, found in the third isle.",
    appearance:
      "Sally Stageplay is one of the sole human characters in the game, alongside Captain Brineybeard and Dr. Kahl, and she, along with the other characters, has a very basic design. Sally is a young woman, styled like 20s and 30s and possessing a lanky figure. She has fair skin, rosy cheeks, close-set pie eyes, a medium-length nose, red lipstick, and curly/puffy pale-blond hair (clearly a towhead) pulled into three segments (two pigtails and one ponytail) held in place with turquoise hairbands.",
    personality:
    ...
    coverImage: require("../assets/bosses/isleThree/sally-stageplay/sally-stageplay.png"),
    images: [
      require("../assets/bosses/isleThree/sally-stageplay/sally-stageplay.gif"),
      require("../assets/bosses/isleThree/sally-stageplay/sally-stageplay2.png"),
      require("../assets/bosses/isleThree/sally-stageplay/sally-stageplay3.png"),
      require("../assets/bosses/isleThree/sally-stageplay/sally-stageplay4.png"),
    ],
    difficulty: 3,
    isle: 3,
  },
  {
    ...
    description:
      "A ghostly train boss with a spectral crew, found in the third isle.",
    appearance:
    ...
    coverImage: require("../assets/bosses/isleThree/phantom-express/phantom-express.png"),
    images: [
      require("../assets/bosses/isleThree/phantom-express/phantom-express.gif"),
      require("../assets/bosses/isleThree/phantom-express/phantom-express2.png"),
      require("../assets/bosses/isleThree/phantom-express/phantom-express3.png"),
      require("../assets/bosses/isleThree/phantom-express/phantom-express.png"),
    ],
    difficulty: 3.5,
    isle: 3,
  },
  {
    ...
    description:
      "Pirategoodshot	Captain Brineybeard is the second of two initially available bosses after entering this isle.",
    appearance:
    ...
    coverImage: require("../assets/bosses/isleThree/captain-brineybeard/captain-brineybeard.png"),
    images: [
      require("../assets/bosses/isleThree/captain-brineybeard/captain-brineybeard2.png"),
      require("../assets/bosses/isleThree/captain-brineybeard/captain-brineybeard3.png"),
      require("../assets/bosses/isleThree/captain-brineybeard/captain-brineybeard4.png"),
      require("../assets/bosses/isleThree/captain-brineybeard/captain-brineybeard.png"),
    ],
    difficulty: 3.5,
    isle: 3,
  },
  {
    ...
    name: "Werner Werman",
    description:
      "Werner Werman is a boss unlocked after defeating Sally Stageplay or completing either of the Run n' Gun levels Perilous Piers and Rugged Ridge.",
    appearance:
    ...
    coverImage: require("../assets/bosses/isleThree/werner-werman/werner-werman.png"),
    images: [
      require("../assets/bosses/isleThree/werner-werman/werner-werman2.png"),
      require("../assets/bosses/isleThree/werner-werman/werner-werman3.png"),
      require("../assets/bosses/isleThree/werner-werman/werner-werman.png"),
      require("../assets/bosses/isleThree/werner-werman/werner-werman4.png"),
    ],
    difficulty: 3,
    isle: 3,
  },
  {
    ...
    coverImage: require("../assets/bosses/isleThree/cala-maria/cala-maria.png"),
    images: [
      require("../assets/bosses/isleThree/cala-maria/cala-maria2.png"),
      require("../assets/bosses/isleThree/cala-maria/cala-maria3.png"),
      require("../assets/bosses/isleThree/cala-maria/cala-maria4.png"),
      require("../assets/bosses/isleThree/cala-maria/cala-maria5.png"),
    ],
    appearance:
    ...
    personality:
      "Cala Maria is said to be playful, but not to be trifled with. Cala Maria seems to be a flirty and vivacious being. She appears to be trying to seduce Cuphead and Mugman, as seen in her intro where she makes a sweet 'yoo-hoo!' sound while fluttering her eyelashes and making a pose. She may be trying to tempt them in closer and catch them off-guard, so she can attack them. A classic move for mythological sirens. Her first phase death message only helps support this. She becomes more cruel after she is forcefully transformed into a gorgon-mermaid, due to electric eels biting her waist and shocking her.",
    difficulty: 3.5,
    isle: 3,
  },
  {
    ...
    description:
      "A mechanical boss with robotic attacks, found in the third isle.",
    appearance:
    ...
    coverImage: require("../assets/bosses/isleThree/dr-kahls-robot/dr-kahls-robot.png"),
    images: [
      require("../assets/bosses/isleThree/dr-kahls-robot/dr-kahls-robot.gif"),
      require("../assets/bosses/isleThree/dr-kahls-robot/dr-kahls-robot2.png"),
      require("../assets/bosses/isleThree/dr-kahls-robot/dr-kahls-robot3.png"),
      require("../assets/bosses/isleThree/dr-kahls-robot/dr-kahls-robot4.png"),
    ],
    difficulty: 4.5,
    isle: 3,
  },
  {
    ...
    name: "King Dice",
    description:
      "The devil's right-hand man and casino owner, found in the third isle.",
    appearance:
    ...
    coverImage: require("../assets/bosses/isleThree/king-dice/king-dice.png"),
    images: [
      require("../assets/bosses/isleThree/king-dice/king-dice.gif"),
      require("../assets/bosses/isleThree/king-dice/king-dice3.png"),
      require("../assets/bosses/isleThree/king-dice/king-dice4.png"),
      require("../assets/bosses/isleThree/king-dice/king-dice5.png"),
      require("../assets/bosses/isleThree/king-dice/king-dice6.png"),
      require("../assets/bosses/isleThree/king-dice/king-dice7.png"),
      require("../assets/bosses/isleThree/king-dice/king-dice8.png"),
      require("../assets/bosses/isleThree/king-dice/king-dice9.png"),
      require("../assets/bosses/isleThree/king-dice/king-dice10.png"),
      require("../assets/bosses/isleThree/king-dice/king-dice11.png"),
    ],
    difficulty: 4.5,
    isle: 3,
  },
  {
    ...
    name: "The Devil",
    description:
      "The final boss of the base game, a devilish foe with several challenging phases, found in the third isle.",
    appearance:
    ...
    coverImage: require("../assets/bosses/isleThree/devil/devil.png"),
    images: [
      require("../assets/bosses/isleThree/devil/devil.gif"),
      require("../assets/bosses/isleThree/devil/devil2.gif"),
      require("../assets/bosses/isleThree/devil/devil3.gif"),
      require("../assets/bosses/isleThree/devil/devil4.gif"),
    ],
    difficulty: 4,
    isle: 3,
  },
